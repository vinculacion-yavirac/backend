    ...
    public function run()
    {
     ...
     $projects = [
         [
             ...
             'schedule_crono' =>json_encode("{nombreArchivo: '' , base64textString: ''}"),
            'financing'=>json_encode("{nombreArchivo: '' , base64textString: ''}"), 
        ...
        [
            ...
            'linking_activity' => json_encode(['Actividad 1', 'Actividad 2']),
            'schedule_crono' =>json_encode("{nombreArchivo: '' , base64textString: ''}"),
            'financing'=>json_encode("{nombreArchivo: '' , base64textString: ''}"),             'sectors_intervention' => json_encode(['Sector 1', 'Sector 2']),
            'strategic_axes' => json_encode(['Eje 1', 'Eje 2']),
            'objetive'=>'objetivo del proyecto',
            'description' => 'Descripción del proyecto',
            'situational_analysis' => 'Análisis situacional',
